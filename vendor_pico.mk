...
PRODUCT_COPY_FILES += \
    ...
    vendor/htc/pico/lib/libllvm-arm.so:system/vendor/lib/libllvm-arm.so \
    vendor/htc/pico/lib/libOpenCL.so:system/vendor/lib/libOpenCL.so \
    vendor/htc/pico/lib/libOpenVG.so:system//vendorlib/libOpenVG.so \
    ...
    vendor/htc/pico/lib/egl/libq3dtools_adreno.so:system/vendorlib/egl/libq3dtools_adreno.soe 
